...
class Player:
    def __init__(self, name, playerID, token, websocket):
        # input we get 
        self.name = name
    ...
    def getPlayerAttrib(self):
        print("Name: ", self.name, " | ","ID: ", self.playerID, " | ","Token Name: ", self.token.getName(), " | ","Token Position: ", self.tokenPosition, " | websocket: ", self.websocket)
